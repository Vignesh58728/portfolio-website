...
export const Projects = () => {
  ...
  return (
    <section id="featured-projects" className="py-24 bg-black/60 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            <h2 className="font-bebas text-4xl sm:text-5xl md:text-6xl tracking-wider text-[#EAE0D5] mb-2 uppercase">FEATURED PROJECTS</h2>
            <div className="h-1 w-20 bg-primary rounded-full mb-4"></div>
            <p className="text-gray-400 font-sans text-base sm:text-lg max-w-xl leading-relaxed">
              Explore my latest open source contributions, repositories, and technical experiments, fetched directly from GitHub.
            </p>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-white hover:text-primary transition-colors font-medium text-sm tracking-wide bg-white/10 hover:bg-white/15 px-6 py-3 rounded-full border border-white/20"
          >
